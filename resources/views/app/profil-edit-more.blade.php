        ...
        <div class="col-sm-12">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{$my_mac_address}}</td>
                        <td>name</td>
                        <td>
                            <a href="{{route('profile.edit.remove.macaddress', $my_mac_address)}}"><span class="fa fa-trash-o"></span></a>
                        </td>
                    </tr>
                        @endforeach
                </tbody>
            </table>
            {!! BootForm::select('mac_addresses', "Ajouter une adresse mac", array_combine($mac_addresses,$mac_addresses)) !!}
        </div>
    </div>
